                    ...
                    <div class="bg-white rounder">
                        ...
                        <div className='details'>
                            ...
                            <div class="row new mb-1">
                                ...
                                <div class="col-1  my-2  px-5 currentcolor"><img src={mysvgcross} /><span>Deativated</span></div>
                                <div class="col-1  my-2  px-5"><p>View</p></div>
                                <div class="col-1 px-5"> <button class="bg-white rounded-pill px-3 py-2 mx-2"> Deativated </button></div>
                            ...
                            <div class="row new mb-1">
                                ...
                                <div class="col-1  my-2  px-5 currentcolor"><img src={mysvgcross} /><span>Deactived</span></div>
                                <div class="col-1 my-2   px-5"><p>View</p></div>
                                <div class="col-1 px-5"> <button class="bg-white rounded-pill px-3 py-2 mx-2"> Deactivated</button></div>
                            </div> <hr class="container" />
                            <div class="row new mb-1">
