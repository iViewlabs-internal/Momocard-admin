            ...
            <div className='backcolor'>
                ...
                <div className='container'>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item  p-0 mx-1 active">Home</li>
                            <li class="breadcrumb-item p-0 mx-1 active">CUSTOMER</li>
                            <li class="breadcrumb-item  p-0 mx-1" aria-current="page">ACTIVATED</li>
                        </ol>
                    </nav>
                    ...
                    <div class="bg-white rounder">
                        ...
                        <div class="row mx-3 py-3 pb-1">
                            <div class="col-1 ">
                                <p className='underline container'>All(1000)</p>
                            </div>
                            <div class="col-1">
                                <p>New(25)</p>
                            </div>
                        ...
                        <div className='details'>
                            ...
                            <div class="row new mb-1">
                                ...
                                <div class="col-1  my-2 px-4  currentcolor"><img src={mysvgcross} /><span>Deactivated</span></div>
                            ...
                            <div class="row new mb-1">
                                ...
                                <div class="col-2  my-2  px-5"><p>Added 2hrs ago</p></div>
                                <div class="col-1 my-2  "><img src={mysvg2} className="icon2 mx-2" /><span>Both</span></div>
                                <div class="col-1  my-2  px-4 textcolor"><img src={mysvg} /><span>Activated</span></div>
                                <div class="col-1  my-2  px-5"><p>View</p></div>
                                <div class="col-1 px-5"> <button class="bg-white rounded-pill px-3 py-2 mx-2"> Activated</button></div>
                            </div> <hr class="container" />
                            <div class="row new mb-1">
