            ...
            {/* <div className='navbar'>
                <ul>
                    ...
                    <div className='subnav'>
                        ...
                        <li className='col-1  '>
                            <Link to="/AdminCustomerAll" className='present' >CUSTOMERS</Link>
                        </li>
                    </div>
                    ...
                    <div className="bg-white rounder">
                        ...
                        <div className="row mx-3 py-3 pb-1">
                            ...
                            <div className="col-7 px-5">
                                <p>
                                    <Link to="/AdminCustomerDeactivated" className='present'>Deactivated(25)</Link>
                                </p>
                            </div>
                            <div className="col-1">
                        ...
                        <div className='details'>
                            ...
                            <div className="row new pt-2 mb-1">
                                ...
                                <div className="col-1  my-2 shift  px-5  svg-alig currentcolor"><img src={mysvgcross} className="icon2 mx-1" /><span>Deactivated</span></div>
                                <div className="col-1  my-2  px-5"><p>View</p></div>
                                <div className="col-1 px-5 shiftt"> <button className="bg-white rounded-pill px-3 py-2 mx-2" onClick={() => click()} > Deativated </button></div>
                            ...
                            <div className="row new mb-1">
                                ...
                                <div className="col-2 my-2   px-2"><p>Added 2hrs ago</p></div>
                                <div className="col-1 my-2  shift "><img src={mysvg2} className="icon2 mx-2" /><span>Both</span></div>
                                <div className="col-1  my-2 shift  px-5  svg-alig currentcolor"><img src={mysvgcross} className="icon2 mx-1" /><span>Deativated</span></div>
                                <div className="col-1 my-2   px-5"><p>View</p></div>
                            ...
                            <div className="row new mb-1">
                                ...
                                <div className="col-1  my-2 shift  px-5  svg-alig currentcolor"><img src={mysvgcross} className="icon2 mx-1" /><span>Deactivated</span></div>
                                <div className="col-1  my-2  px-5"><p>View</p></div>
                                <div className="col-1 px-5 shiftt"> <button className="bg-white rounded-pill px-3 py-2 mx-2"> ADeativated </button></div>
                            </div> <hr className="container" />
                            <div className="row new mb-1">
                                <div className="col-1"><p><img src={require("../../images/cust3.png")} className="custimg" alt="customer_pic" /></p></div>
