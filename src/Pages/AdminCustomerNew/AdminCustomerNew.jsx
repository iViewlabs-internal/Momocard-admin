                ...
                <div className='container'>
                    ...
                    <div className="bg-white rounder">
                        ...
                        <div className="row mx-3 py-3 pb-1">
                            ...
                            <div className="col-1">
                                <p>
                                    <Link to="/AdminCustomerNew">New(25)</Link>
                                </p>
                            </div>
                        ...
                        <div className='details'>
                            ...
                            <div className="row new mb-1">
                                <div className="col-1 mb-0"><p><img src={require("../../images/cust1.png")} alt="customer_pic" /></p></div>
                                ...
                                <div className="col-1 my-2  px-5">    <Link to="/CustomerProfile" className='now'>View</Link></div>
